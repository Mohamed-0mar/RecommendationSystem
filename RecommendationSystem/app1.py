...
# Recommendation function with movie_limit argument
...
def set_limits(model):
    if model == 'User_User Based':
        return (999, 799)  # user_id limit 1000 -> 999, movie_id limit 800 -> 799
    elif model == 'Item_Item Based':
        return (5999, 1999)  # user_id limit 6000 -> 5999, movie_id limit 2000 -> 1999
    else:
        return (6039, 3705)  # user_id limit 6040 -> 6039, movie_id limit 3706 -> 3705
